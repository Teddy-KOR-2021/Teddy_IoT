...
def run():
    ...
    #     os.system(NEWCODE)  
    for i in range(3):
        file_name = f'/home/pi/Teddy_PI/image/{nowtime}0{i}.jpg'
        bucket =  'kd1-teddy-records-bucket2021'
        key = f'image/{nowtime}0{i}.jpg'
    ...
    img_url1 = f"https://kd1-teddy-records-bucket2021.s3.eu-west-2.amazonaws.com/image/{nowtime}00.jpg"
